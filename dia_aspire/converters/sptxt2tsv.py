...
def convert_sptxt2tsv(inp):
    ...
    da1['FragmentNumber'] = pd.to_numeric(byions5['FragmentNumber'], errors='coerce')
    ...
    daout5x = daout5x[daout5x['FragmentNumber']!=1]
