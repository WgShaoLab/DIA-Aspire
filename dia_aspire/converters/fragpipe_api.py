...
def merge_libraries(sample_library_path, systemhc_lib_paths, output_dir):
    ...
    sample_library2['FragmentCharge'] = 1
    ...
    cols = ['PrecursorMz', 'ProductMz', 'ProteinId', \
            'PeptideSequence', 'ModifiedPeptideSequence', 'PrecursorCharge', 'FragmentCharge', 'FragmentType','FragmentSeriesNumber',\
    ...
    try:
        ...
        col_map = {
            ...
            'FragmentSeriesNumber': 'FragmentNumber',
